        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <button id="proceed" class="btn btn-danger form-control">Proceed to Buy</button>
                    </div>
                    <div class="col">
                        <form method="post">
                            ...
                            if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                                ...
                                echo '<button id="Add" type="submit" name="productCart" class="btn btn-warning font-size-16 form-control">Add to Cart</button>';
                            }
                            ?>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">Khareedo <br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">Khareedo </a>(4.5 out of 5 | 18,198 ratings)</small>
